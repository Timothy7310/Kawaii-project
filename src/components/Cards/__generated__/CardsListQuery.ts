...
export type CardsListQueryVariables = Types.Exact<{
 ...
 *
 * @example
 * const { result, loading, error } = useCardsListQuery({
 *   page: // value for 'page'
 ...
 * });
 */
export function useCardsListQuery(variables: CardsListQueryVariables | VueCompositionApi.Ref<CardsListQueryVariables> | ReactiveFunction<CardsListQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<CardsListQuery, CardsListQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<CardsListQuery, CardsListQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<CardsListQuery, CardsListQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<CardsListQuery, CardsListQueryVariables>(CardsListQueryDocument, variables, options);
}
export function useCardsListQueryLazyQuery(variables: CardsListQueryVariables | VueCompositionApi.Ref<CardsListQueryVariables> | ReactiveFunction<CardsListQueryVariables> = {}, options: VueApolloComposable.UseQueryOptions<CardsListQuery, CardsListQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<CardsListQuery, CardsListQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<CardsListQuery, CardsListQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<CardsListQuery, CardsListQueryVariables>(CardsListQueryDocument, variables, options);
}
export type CardsListQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<CardsListQuery, CardsListQueryVariables>;