<template>
  <section
    v-if="info.characters"
    class="characters"
  >
    <h2 class="characters__title overview-title">Characters</h2>
    <MediaCharactersList :characters="info.characters" />
  </section>
  ...
  <section
    ...
    class="staff"
  >
    <h2 class="staff__title overview-title">Staff</h2>
    <MediaStaffList :staff="info.staff" />
  </section>
